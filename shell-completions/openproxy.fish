...
complete -c openproxy -n "__fish_openproxy_using_subcommand help; and not __fish_seen_subcommand_from provider key pool route completion help" -f -a "provider"
complete -c openproxy -n "__fish_openproxy_using_subcommand help; and not __fish_seen_subcommand_from provider key pool route completion help" -f -a "key"
complete -c openproxy -n "__fish_openproxy_using_subcommand help; and not __fish_seen_subcommand_from provider key pool route completion help" -f -a "pool"
complete -c openproxy -n "__fish_openproxy_using_subcommand help; and not __fish_seen_subcommand_from provider key pool route completion help" -f -a "route"
complete -c openproxy -n "__fish_openproxy_using_subcommand help; and not __fish_seen_subcommand_from provider key pool route completion help" -f -a "completion"
complete -c openproxy -n "__fish_openproxy_using_subcommand help; and not __fish_seen_subcommand_from provider key pool route completion help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
