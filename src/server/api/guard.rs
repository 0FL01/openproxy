...
///
/// These are sensitive operations (cowork settings and credential management)
/// that must only be reachable from
...
#[allow(dead_code)]
pub const LOCALLY_ONLY_PATHS: &[&str] = &["/api/cli-tools/cowork-settings", "/api/keys"];
