...
export const OAUTH_PROVIDERS: Record<string, Provider> = {
  ...
  github: { id: "github", alias: "gh", name: "GitHub Copilot", icon: "code", color: "#333333", serviceKinds: ["llm", "embedding"], embeddingConfig: { baseUrl: "https://models.github.ai/inference/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "text-embedding-3-small", name: "Text Embedding 3 Small (GitHub)", dimensions: 1536 }, { id: "text-embedding-3-large", name: "Text Embedding 3 Large (GitHub)", dimensions: 3072 }] }, website: "https://github.com/features/copilot", notice: { signupUrl: "https://github.com/features/copilot" }, priority: 25, authModes: ["device_code"] },
...
export const APIKEY_PROVIDERS: Record<string, Provider> = {
  ...
  reka: { id: "reka", alias: "reka", name: "Reka", icon: "psychology", color: "#8B5CF6", textIcon: "RK", website: "https://reka.ai", notice: { apiKeyUrl: "https://platform.reka.ai" } },
  nlpcloud: { id: "nlpcloud", alias: "nlpc", name: "NLP Cloud", icon: "cloud", color: "#3B82F6", textIcon: "NC", website: "https://nlpcloud.com", notice: { apiKeyUrl: "https://nlpcloud.com" } },
  bazaarlink: { id: "bazaarlink", alias: "bzl", name: "BazaarLink", icon: "storefront", color: "#F59E0B", textIcon: "BZ", website: "https://bazaarlink.ai", notice: { apiKeyUrl: "https://bazaarlink.ai" } },
  completions: { id: "completions", alias: "comp", name: "Completions", icon: "auto_fix_high", color: "#10B981", textIcon: "CM", website: "https://completions.me", notice: { apiKeyUrl: "https://completions.me" } },
  ...
  freetheai: { id: "freetheai", alias: "fta", name: "FreeTheAI", icon: "volunteer_activism", color: "#14B8A6", textIcon: "FA", website: "https://freetheai.xyz", notice: { apiKeyUrl: "https://freetheai.xyz" } },
  ...
  kluster: { id: "kluster", alias: "kl", name: "Kluster", icon: "hub", color: "#0284C7", textIcon: "KL", website: "https://kluster.ai", notice: { apiKeyUrl: "https://kluster.ai" } },
  predibase: { id: "predibase", alias: "pb", name: "Predibase", icon: "model_training", color: "#6366F1", textIcon: "PB", website: "https://predibase.com", notice: { apiKeyUrl: "https://app.predibase.com" } },
  bytez: { id: "bytez", alias: "btz", name: "Bytez", icon: "code", color: "#1D4ED8", textIcon: "BT", website: "https://bytez.com", notice: { apiKeyUrl: "https://bytez.com" } },
  morph: { id: "morph", alias: "morph", name: "Morph", icon: "auto_awesome", color: "#A855F7", textIcon: "MR", website: "https://morphllm.com", notice: { apiKeyUrl: "https://morphllm.com" } },
  ...
  puter: { id: "puter", alias: "puter", name: "Puter", icon: "cloud", color: "#2563EB", textIcon: "PT", website: "https://puter.com", notice: { apiKeyUrl: "https://puter.com" } },
  uncloseai: { id: "uncloseai", alias: "uca", name: "UncloseAI", icon: "lock_open", color: "#64748B", textIcon: "UA", website: "https://unturf.com", noAuth: true },
...
export function getProvidersByKind(kind: ServiceKind): Provider[] {
