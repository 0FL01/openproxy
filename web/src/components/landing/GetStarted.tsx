            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Point your CLI tools to http://localhost:4623</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("cargo run -- --port 4623")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">cargo run -- --port 4623</span>
