...
export default function AddCompatibleModal({ variant, isOpen, onClose, onCreated }: AddCompatibleModalProps): React.ReactNode {
  ...
  }, [config.hasApiType ? (formData as any).apiType : isOpen]);
    ...
    try {
      const res = await fetch("/api/provider-nodes", {
        ...
        body: JSON.stringify({
          ...
          ...(config.hasApiType ? { apiType: (formData as any).apiType } : {}),
