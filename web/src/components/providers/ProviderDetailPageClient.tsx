...
import { Card, Button, Badge, Input, Modal, CardSkeleton, OAuthModal, CursorAuthModal, GitLabAuthModal, Select, EditConnectionModal, NoAuthProxyCard, FreeTierLimits } from "@/shared/components";
...
export default function ProviderDetailPageClient() {
  ...
  const autoPingSettingsKey =
    AUTO_PING_SETTINGS_KEYS[providerId as keyof typeof AUTO_PING_SETTINGS_KEYS];
  ...
  if (!providerInfo) {
    return (
      <div className="text-center py-20">
        ...
        <a href="/dashboard/providers" className="text-primary mt-4 inline-block">
          Back to Providers
        </a>
      </div>
    );
